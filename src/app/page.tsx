    ...
    <div className="space-y-24 sm:space-y-32">
      ...
      <section className="relative min-h-[92vh] flex items-center justify-center overflow-hidden pt-24 pb-16">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center space-y-8 animate-fade-in">
          <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full border border-gold-500/40 bg-obsidian-900/80 backdrop-blur-md text-xs font-semibold uppercase tracking-[0.25em] text-gold-400 shadow-xl">
            <Sparkles className="w-3.5 h-3.5" />
            <span>Worldwide Creative Studio • 2024 / 2025 Bookings Open</span>
          </div>

          <h1 className="font-serif text-4xl sm:text-6xl md:text-7xl font-bold tracking-tight text-cream-50 leading-[1.1]">
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/portfolio"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 py-4 rounded-full bg-gold-500 hover:bg-gold-400 text-obsidian-950 font-bold text-xs uppercase tracking-widest transition-all duration-300 shadow-[0_0_30px_rgba(212,175,55,0.35)]"
            >
            ...
            <Link
              href="/contact"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 py-4 rounded-full bg-obsidian-900/90 border border-white/20 hover:border-gold-500/60 text-cream-100 font-semibold text-xs uppercase tracking-widest transition-all duration-300 hover:bg-obsidian-850"
            >
      ...
      <section className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 p-8 sm:p-12 rounded-2xl bg-obsidian-900/60 border border-white/5 backdrop-blur-sm">
          {STATS.map((stat, idx) => (
            <div key={idx} className="text-center space-y-1">
              <span className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold gold-gradient-text block">
                {stat.value}
              </span>
      ...
      <section className="max-w-7xl mx-auto px-6 space-y-12">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-white/10 pb-8">
          ...
          <Link
            href="/portfolio"
            className="inline-flex items-center gap-2 text-xs uppercase tracking-widest text-gold-400 hover:text-gold-300 font-semibold transition-colors"
          >
      ...
      <section className="max-w-7xl mx-auto px-6 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {SERVICES.map((service) => (
            <div
              key={service.id}
              className="p-8 rounded-2xl bg-obsidian-850 border border-white/10 hover:border-gold-500/40 transition-all duration-300 flex flex-col justify-between group"
            >
              <div className="space-y-4">
                ...
                <div className="pt-2">
                  <span className="text-xs uppercase tracking-wider text-slate-500">Starting From</span>
              ...
              <div className="pt-6 mt-6 border-t border-white/5 flex items-center justify-between">
                ...
                <Link
                  href="/services"
                  className="inline-flex items-center gap-1.5 text-xs text-gold-400 group-hover:text-gold-300 uppercase tracking-wide font-medium"
                >
                  <span>Details</span>
      ...
      <section className="bg-obsidian-900 border-y border-white/5 py-20">
        <div className="max-w-7xl mx-auto px-6 space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-obsidian-850 border border-white/5 space-y-4">
      ...
      <section className="max-w-7xl mx-auto px-6 space-y-12">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          ...
          <Link
            href="/about"
            className="text-xs uppercase tracking-widest text-gold-400 hover:text-gold-300 font-semibold"
          >
            Meet The Full Team →
          </Link>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-12">
        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-obsidian-900 via-obsidian-850 to-obsidian-900 border border-gold-500/30 p-10 sm:p-16 text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/contact"
              className="w-full sm:w-auto px-8 py-4 rounded-full bg-gold-500 hover:bg-gold-400 text-obsidian-950 font-bold text-xs uppercase tracking-widest transition-all shadow-[0_0_25px_rgba(212,175,55,0.3)]"
            >
              Submit Studio Brief
            </Link>
            <a
              ...
              className="w-full sm:w-auto px-8 py-4 rounded-full border border-emerald-500/40 text-emerald-400 hover:bg-emerald-500/10 font-semibold text-xs uppercase tracking-widest transition-all"
            >
