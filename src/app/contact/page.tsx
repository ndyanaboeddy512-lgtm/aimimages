          ...
          <div className="p-6 sm:p-8 rounded-2xl bg-obsidian-850 border border-white/10 space-y-6">
            ...
            <div className="space-y-4 sm:space-y-5 text-sm">
              <div className="flex items-start gap-3 text-slate-300">
                ...
                <div>
                  <span className="block text-[11px] uppercase tracking-wider text-slate-500">Primary Hub</span>
              ...
              <div className="flex items-start gap-3 text-slate-300">
                ...
                <div>
                  <span className="block text-[11px] uppercase tracking-wider text-slate-500">Studio Line</span>
                  <a
              ...
              <div className="flex items-start gap-3 text-slate-300">
                ...
                <div>
                  <span className="block text-[11px] uppercase tracking-wider text-slate-500">Consultation Hours</span>
